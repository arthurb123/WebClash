...
var defaultConnection_1 = __importDefault(require("./defaultConnection"));
...
var WebRTCConnection = /** @class */ (function (_super) {
    ...
    function WebRTCConnection(id, serverOptions) {
        var _this = _super.call(this, id) || this;
        _this.toJSON = function () {
            return __assign({}, _super.prototype.toJSON.call(_this), { iceConnectionState: _this.iceConnectionState, localDescription: _this.localDescription, remoteDescription: _this.remoteDescription, signalingState: _this.signalingState });
        };
        var _a = serverOptions.iceServers, iceServers = _a === void 0 ? [] : _a, _b = serverOptions.iceTransportPolicy, iceTransportPolicy = _b === void 0 ? 'all' : _b, dataChannelOptions = __rest(serverOptions, ["iceServers", "iceTransportPolicy"]);
        _this.options = {
        ...
        _this.channel = new channel_1.default(_this, dataChannelOptions);
        return _this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.waitUntilIceGatheringStateComplete(this.peerConnection, this.options)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
    ...
    WebRTCConnection.prototype.waitUntilIceGatheringStateComplete = function (peerConnection, options) {
        return __awaiter(this, void 0, void 0, function () {
            var totalIceCandidates, timeToHostCandidates, deferred, timeout, onIceCandidate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        timeout = options.setTimeout(function () {
